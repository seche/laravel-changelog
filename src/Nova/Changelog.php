...
namespace Seche\LaravelChangelog\Nova;
...
class Changelog extends Resource
{
     ...
     * @var string
     */
    public static $model = \Seche\LaravelChangelog\Models\Changelog::class;
    ...
    public static function label() {
        return __('changelog::nova.label');
    }
    ...
    public static function group() {
        return __('changelog::nova.group');
    }
}
